 ...
 */
export function buildIngredientBadges(ingredient: PhotoIngredient): DietaryBadge[] {
...
export function DietaryBadges({ ingredient }: { ingredient: PhotoIngredient }) {
  const badges = buildIngredientBadges(ingredient)
 ...
 */
export function buildAggregateBadges(ingredients: PhotoIngredient[]): DietaryBadge[] {
  const visible = ingredients.filter((i) => i.visible)
  const perIngredient = visible.map(buildIngredientBadges)
