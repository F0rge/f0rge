...
function NiaConversation({
  ...
  return (
    <>
      <div
        className="firstout-nia-dock__messages"
        ref={messagesRef}
      ...
      >
        {loadingThread ? (
          ...
          <p className="firstout-nia-dock__empty cds--type-body-01">
          ...
          <>
            {messages.map((message) => {
              ...
              return (
                <div
                  key={message.id}
                  className={`firstout-nia-dock__message firstout-nia-dock__message--${message.role}`}
                >
                  {messageShowsDockProse(message) ? (
                    message.role === "assistant" ? (
                      <div className="firstout-nia-dock__bubble">
                        <NiaMarkdown text={message.content} />
                      </div>
                    ) : (
                      <p className="firstout-nia-dock__bubble">{message.content}</p>
                    )
                  ) : null}
                  {hasCard ? (
                    <NiaStructuredCard
            ...
            {streaming ? (
              <div className="firstout-nia-dock__message firstout-nia-dock__message--assistant">
                <NiaThinking
                  streaming={streaming}
      ...
      {showSuggestions && !hasUserMessage ? (
        <div className="firstout-nia-dock__suggestions">
      ...
      <div className="firstout-nia-dock__composer">
        ...
        />
        <div className="firstout-nia-dock__composer-actions">
          <IconButton
            kind="ghost"
            size="md"
            label="Dictate"
  ...
  return (
    <>
      ...
      >
        ...
        <div className="firstout-nia-dock__inner">
          <header className="firstout-nia-dock__header">
            ...
            <div className="firstout-nia-dock__header-actions">
              <IconButton
                kind="ghost"
                size="sm"
          ...
          {!modalOpen ? <NiaConversation {...conversationProps} /> : (
            <p className="firstout-nia-dock__expanded-hint cds--type-helper-text-01">
      ...
      <Modal
        ...
        passiveModal
        size="lg"
        className="firstout-nia-modal"
        onRequestClose={() => setModalOpen(false)}
      >
        <div className="firstout-nia-modal__body">
          {error ? (
            <InlineNotification
              kind="error"
              title="Nia"
        ...
        <div className="firstout-nia-modal__footer">
      ...
      >
        {loadingThreads ? (
          ...
          <ul className="firstout-nia-history-list">
            {threads.map((thread) => (
              <li key={thread.id} className="firstout-nia-history-list__item">
                <button
                  type="button"
                  className="firstout-nia-history-list__select"
                  onClick={() => {
                    void loadThread(thread.id);
                    setHistoryOpen(false);
                  }}
                >
                  <span className="firstout-nia-history-list__title">{thread.title}</span>
                  <span className="firstout-nia-history-list__time">
                    {formatRelativeThreadTime(thread.updated_at)}
                  </span>
                </button>
                <div className="firstout-nia-history-list__actions">
                  <IconButton
                    kind="ghost"
                    size="sm"
