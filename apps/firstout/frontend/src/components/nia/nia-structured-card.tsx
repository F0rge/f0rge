...
function NeedsFieldsCard({
  ...
  return (
    <Tile className="firstout-nia-card firstout-nia-card--fields">
      ...
      <div className="firstout-nia-card__actions">
        <Button
          size="sm"
          kind="primary"
...
function CanvasSpecCard({
  ...
  return (
    <Tile className="firstout-nia-card firstout-nia-card--nav">
...
function TransferDraftCard({
  ...
  return (
    <Tile className="firstout-nia-card firstout-nia-card--undo">
      <p className="cds--type-label-01">Transfer draft</p>
      <p className="cds--type-body-01">{payload.transfer_number}</p>
      <p className="firstout-muted-text">Status: {statusLabel}</p>
...
export function NiaStructuredCard({
  ...
  if (isOverdueInvoices(structured)) {
    return (
      <Tile className="firstout-nia-card firstout-nia-card--list">
              ...
              {structured.invoices.map((invoice) => (
                <StructuredListRow key={invoice.id}>
                  <div>
                    ...
                    <p className="firstout-muted-text">R {invoice.remaining_zar} remaining</p>
                  </div>
                </StructuredListRow>
              ))}
            </StructuredListBody>
  ...
  if (structured.kind === "your_call") {
    ...
    return (
      <Tile className="firstout-nia-card firstout-nia-card--choice">
  ...
  if (isNeedsOk(structured)) {
    return (
      <Tile className="firstout-nia-card firstout-nia-card--approval">
