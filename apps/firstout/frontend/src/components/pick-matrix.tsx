...
export function PickMatrix({
  ...
  return (
    <TableContainer className="firstout-pick-matrix">
      <Table size="sm">
        <TableHead>
          <TableRow>
            ...
            return (
              <TableRow key={line.sku_id}>
                <TableCell>
                  ...
                  <div className="firstout-muted-text">{line.sku_name}</div>
                </TableCell>
                ...
                {locations.map((location) => {
                  ...
                  return (
                    <TableCell key={location.id}>
                      <div className="firstout-muted-text">On hand {available}</div>
                      <NumberInput
