...
export function WmsLocationBar({ floor, locationId, onChange }: WmsLocationBarProps) {
  ...
  return (
    <div className="firstout-wms-location" role="region" aria-label="Where you are standing">
      <p className="firstout-wms-location__label cds--type-label-01">Where am I standing?</p>
      <ContentSwitcher
