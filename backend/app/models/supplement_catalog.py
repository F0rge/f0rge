...
class SupplementCatalogItem(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "key", name="uq_supplement_catalog_user_id_key"),
        Index("ix_supplement_catalog_user_id", "user_id"),
    )
    ...
    # `key` uniqueness is enforced per-user by uq_supplement_catalog_user_id_key above;
