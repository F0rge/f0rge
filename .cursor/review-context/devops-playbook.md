...
|---|---|---|---|
| Dev | `develop` | `marrow-dev`, `marrow-mcp-dev`, `marrow-ui-dev` | `fly-deploy.yml` (`environment=develop`) |
| Prod | `main` | `marrow`, `marrow-mcp`, `marrow-ui` | `fly-deploy.yml` (`environment=main`) |
